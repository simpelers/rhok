...
public class Bootstrap extends Job {
    ...
    public void doJob() 
    {
        if (User.count() == 0) 
        {
            ...
            Location l3 = new Location("Scary Place", 18.59, -72.3);
            l3.save();
            ...
            Incident i = new Incident(cat1, "Shoots", "Several gunshots were heard.", calendar.getTime(), 75, l, "North", user1);
            i.save();
            Incident i2 = new Incident(cat2, "Tanks burning", "A clash has left one tank on fire.", calendar.getTime(), 200, l2, "South", user1);
            i2.save();
        }
    }
